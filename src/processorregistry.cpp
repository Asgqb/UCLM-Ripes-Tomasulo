...
#include "processors/RISC-V/rv5s_1s_db/rv5s_1s_db.h"
#include "processors/RISC-V/rv5s_3s/rv5s_3s.h"
...
ProcessorRegistry::ProcessorRegistry() {
  ...
  addProcessor(ProcInfo<vsrtl::core::RV5S_NO_FW_HZ<uint32_t>>(
      ...
      rv5s_no_fw_hz_desc, rv5s_no_fw_hz_tags, layouts, defRegVals));
  ...
  addProcessor(ProcInfo<vsrtl::core::RV5S_NO_HZ<uint32_t>>(
      ...
      rv5s_no_hz_desc, rv5s_no_hz_tags, layouts, defRegVals));
  ...
  addProcessor(ProcInfo<vsrtl::core::RV5S_NO_FW<uint32_t>>(
      ...
      rv5s_no_fw_desc, rv5s_no_fw_tags, layouts, defRegVals));
  ...
  addProcessor(ProcInfo<vsrtl::core::RV5S<uint64_t>>(
      ProcessorID::RV64_5S, "5-stage processor", rv5s_desc, rv5s_tags, layouts,
      defRegVals));

  // RISC-V 5-stage (2-slot delayed branch)
  layouts = {{"Standard",
              ":/layouts/RISC-V/rv5s/rv5s_standard_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.29, 0}},
  ...
  layouts = {{"Standard",
              ":/layouts/RISC-V/rv5s_1s/rv5s_1s_standard_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.29, 0}},
               {{0, 2}, QPointF{0.55, 0}},
               {{0, 3}, QPointF{0.75, 0}},
               {{0, 4}, QPointF{0.87, 0}}}},
             {"Extended",
              ":/layouts/RISC-V/rv5s_1s/rv5s_1s_extended_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.28, 0}},
               {{0, 2}, QPointF{0.54, 0}},
               {{0, 3}, QPointF{0.78, 0}},
  ...
  layouts = {{"Standard",
              ":/layouts/RISC-V/rv5s_3s/rv5s_3s_standard_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.29, 0}},
               {{0, 2}, QPointF{0.55, 0}},
               {{0, 3}, QPointF{0.75, 0}},
               {{0, 4}, QPointF{0.87, 0}}}},
             {"Extended",
              ":/layouts/RISC-V/rv5s_3s/rv5s_3s_extended_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.28, 0}},
               {{0, 2}, QPointF{0.54, 0}},
               {{0, 3}, QPointF{0.78, 0}},
  ...
  layouts = {{"Standard",
              ":/layouts/RISC-V/rv5s_3s_db/rv5s_3s_db_standard_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.29, 0}},
               {{0, 2}, QPointF{0.55, 0}},
               {{0, 3}, QPointF{0.75, 0}},
               {{0, 4}, QPointF{0.87, 0}}}},
             {"Extended",
              ":/layouts/RISC-V/rv5s_3s_db/rv5s_3s_db_extended_layout.json",
              {{{0, 0}, QPointF{0.08, 0}},
               {{0, 1}, QPointF{0.28, 0}},
               {{0, 2}, QPointF{0.54, 0}},
               {{0, 3}, QPointF{0.78, 0}},
